...
<ExpandableImage src="https://cdn.hashnode.com/res/hashnode/image/upload/v1740162782513/1fdc656d-398c-4e69-ba4a-381c880fffe0.png" alt="Linux installation guide banner showing Pieces for Developers logo" align="center" fullwidth="true" />
...
Click here for documentation [on determining your OS version](/docs/meet-pieces/troubleshooting/linux#checking-ubuntu-version).
...
<ExpandableImage src="https://storage.googleapis.com/hashnode_product_documentation_assets/meet_pieces_assets/meet_pieces/get_started_linux/checking_pieces_desktop_app_for_pieces_os_updates.gif" alt="Animation showing how to check for updates in Pieces Desktop App on Linux" align="center" fullwidth="true" />
...
<ExpandableImage src="https://storage.googleapis.com/hashnode_product_documentation_assets/meet_pieces_assets/meet_pieces/get_started_linux/uninstall_pfd_from_terminal.png" alt="Terminal screenshot showing uninstall commands for Pieces on Linux" align="center" fullwidth="true" />

## Additional Resources

Click here for additional [documentation on troubleshooting](/docs/meet-pieces/troubleshooting/linux) or reach out to [support](/docs/support).