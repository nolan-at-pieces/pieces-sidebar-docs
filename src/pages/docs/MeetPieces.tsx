...
export default function GettingToKnowPieces() {
  // Create markdown-like content for the TableOfContents to parse
    ...
    <div className="max-w-7xl mx-auto flex gap-8">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mb-8 pb-6 border-b border-border">
          <h1 className="text-4xl font-bold mb-2">Getting to Know Pieces</h1>
        ...
        <div className="prose prose-lg max-w-4xl dark:prose-invert">
          ...
          <section className="mb-12">
            <h2 id="introducing-pieces-for-developers" className="text-2xl font-semibold mb-6">Introducing Pieces for Developers</h2>
            <p className="mb-4">
          ...
          <section className="mb-12">
            <h3 id="what-is-pieces" className="text-xl font-semibold mb-4">What is Pieces?</h3>
            <p className="mb-6">
          ...
          <section className="mb-12">
            <h2 id="who-is-pieces-for" className="text-2xl font-semibold mb-6">Who is Pieces For?</h2>
            <p className="mb-4">
          ...
          <section className="mb-12">
            <h2 id="how-do-i-use-pieces" className="text-2xl font-semibold mb-6">How Do I Use Pieces?</h2>
            <p className="mb-6">
